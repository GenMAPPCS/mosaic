...
import org.nrnb.mosaic.utils.download.Status;
    ...
    public synchronized void run() {
        ...
        while (!finished && retryCounter < MAX_RETRY) {
            try {
                ...
                File outputDir = new File(Mosaic.MosaicDatabaseDir);
...
//                System.out.println("Response=" + connection.getResponseMessage());
                ...
                OutputStream out = new BufferedOutputStream(new FileOutputStream(Mosaic.MosaicDatabaseDir + task.getID() + "/" + task.getID() + "part" + partNumber));
